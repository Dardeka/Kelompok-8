...
def print_dfs_results(g, start_vertex='a'):
    """Mencetak hasil analisis DFS"""
    print("="*60)
    print("HASIL ANALISIS GRAF MENGGUNAKAN DFS")
    print("="*60)
    ...
    # DFS Tree
    print(f"1. DFS TREE (dari vertex '{start_vertex}'):")
    ...
    # Topological Sort (menggunakan DFS)
    print("3. TOPOLOGICAL SORT (menggunakan DFS):")
...
def main():
    print("="*60)
    print("PROGRAM DFS (DEPTH-FIRST SEARCH) DAN TOPOLOGICAL SORT")
    print("="*60)
    ...
    while True:
        ...
        if choice == 3:
            print("Terima kasih telah menggunakan program DFS ini!")
            break
            ...
            start_vertex = input("Masukkan vertex start untuk DFS Tree (default: a): ").strip()
            if not start_vertex:
                start_vertex = 'a'
            
            print_dfs_results(g, start_vertex)
